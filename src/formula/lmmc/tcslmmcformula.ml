...
let rec eval_metaformula f =
  ...
  | Tcsmetaformula.FLabelledOp ("<>", l, f) -> FDiamond (as_identifier_to_str l, eval_metaformula f)
  | Tcsmetaformula.FLabelledOp ("[]", l, f) -> FBox (as_identifier_to_str l, eval_metaformula f)
