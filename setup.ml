...
(* OASIS_START *)
(* DO NOT EDIT (digest: e9c811f085cbcc269030abce14ca1b2c) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/tcsprojects/tcslib";
          bugreports = None;
          synopsis = "A multi-purpose library for OCaml.";
          description =
            Some [OASISText.Para "A multi-purpose library for OCaml."];
          tags = [];
          categories = [];
          files_ab = [];
          sections =
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/tcsprojects/tcslib.git";
                      src_repo_browser =
                        Some "https://github.com/tcsprojects/tcslib";
                   ...
                   },
                   {
                      lib_modules =
                        [
                           ...
                           "data/FMap";
                           "data/FSet";
                           "automata/Tcsautohelper";
                           "automata/Tcsautomata";
                           "automata/Tcsautotransform";
                           "automata/Tcsgames";
                           "automata/Tcstransitionsys";
                           "automata/parser/Tcsautomataparser";
                           "automata/parser/Tcsgameparser";
                           "automata/parser/Tcstransitionsysparser";
                           "formula/Tcsmetaformula";
                           "formula/ctlstar/Tcsctlstarformula";
                           "formula/ltl/Tcsltlformula";
                           "formula/ltmc/Tcsltmcformula";
                           "formula/mmc/Tcsmmcformula";
                           "formula/pdl/Tcspdlformula";
                           "formula/parser/Tcsformulaparse";
                           "automata/parser/Tcsgameparserinternal";
                           "automata/parser/Tcsparitysolutionlexer";
                           "automata/parser/Tcsparitygameparser";
                           "automata/parser/Tcsparitygamelexer";
                           "automata/parser/Tcsparitysolutionparser";
                           "automata/parser/Tcsautomataparserinternal";
                           "automata/parser/Tcsautomatalexer";
                           "automata/parser/Tcsautoparser";
                           "formula/parser/Tcsformulaparser";
                           "formula/parser/Tcsformulalexer";
                           "formula/lmmc/Tcslmmcformula";
                           "automata/parser/Tcstslexer";
                           "automata/parser/Tcsltslexer";
                           "automata/parser/Tcstransitionsysparserinternal";
                           "automata/parser/Tcsltsparser";
                           "automata/parser/Tcstsparser"
                        ];
                      lib_pack = false;
     ...
     oasis_digest = Some "\026\184\1504\017\220\144\202\223\196\"/0\140y\179";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
